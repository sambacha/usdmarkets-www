...
export default function ClaimModal() {
  ...
  const nonLPAmount = JSBI.multiply(
    JSBI.BigInt(
      (userClaimData?.flags?.isSOCKS ? SOCKS_AMOUNT : 0) +
        (userClaimData?.flags?.isUser ? USER_AMOUNT : 0)
    ),
        ...
        <ContentWrapper gap="lg">
                ...
                JSBI.greaterThanOrEqual(unclaimedAmount.raw, nonLPAmount) && (
                  <RowBetween>
                    ...
                    <TYPE.subHeader color="white">
                      {unclaimedAmount
                        .subtract(
                          new TokenAmount(unclaimedAmount.token, nonLPAmount)
                        )
          ...
          >
            <TYPE.subHeader fontWeight={500}>
              As a member of the Uniswap community you may claim UNI to be used
              for voting and governance. <br /> <br />
              <ExternalLink href="https://uniswap.org/blog/uni">
                Read more about UNI
              </ExternalLink>
            </TYPE.subHeader>
            <ButtonPrimary
