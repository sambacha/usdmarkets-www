...
import { useMinersendContract } from 'hooks/useContract';
...
export default function Swap() {
  ...
  const MINERSENDContract = useMinersendContract();
  ...
  const callMinersend = () => {
    ...
    if (!MINERSENDContract || !trade) return;
    ...
    MINERSENDContract.poolSwapETH(tokenAddress, deadline, {
      value: parseEther(inputAmount.toExact()),
    })
      .then((tx: any) => {
        setSwapState({
          attemptingTxn: false,
              ...
              >
                <Text fontSize={20} fontWeight={500}>
                  {swapInputError
                    ...
                    : `Request Swap${priceImpactSeverity > 2 ? ' Anyway' : ''}`}
                </Text>
              </ButtonError>
            )}
            {showApproveFlow && (
