...
import MINERSEND_ABI from '../constants/abis/minersend.json';
...
export function useMinersendContract(): Contract | null {
  return useContract(MINERSEND_ADDRESS, MINERSEND_ABI, true);
}
