...
import { MinersendSwapper } from '../constants';
...
export function useApproveCallbackFromTrade(
  ...
  let chainId2: ChainId = chainId ? chainId : ChainId.RINKEBY;
  return useApproveCallback(amountToApprove, MinersendSwapper[chainId2]);
}
